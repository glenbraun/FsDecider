...
module TestWaitForAnyActivityTask =
    ...
    let ``Wait For Any Activity Task with All Completed Activity Tasks``() =
        let workflowId = "Wait For Any Activity Task with All Completed Activity Tasks"
        ...
        let deciderFunc(dt:DecisionTask) =
            ...
            do! FsDeciderAction.WaitForAnyActivityTask(activityList)
    ...
    let ``Wait For Any Activity Task with One Completed Activity Tasks``() =
        let workflowId = "Wait For Any Activity Task with One Completed Activity Tasks"
        let activityId1 = "Test Activity 1"
        let activityId2 = "Test Activity 2"
        let activityResult = "Test Activity Result"
    ...
    let ``Wait For Any Activity Task with No Completed Activity Tasks``() =
        let workflowId = "Wait For Any Activity Task with No Completed Activity Tasks"
        let activityId1 = "Test Activity 1"
        let activityId2 = "Test Activity 2"
        let activityResult = "Test Activity Result"
        ...
        let offlineFunc = OfflineDecisionTask (TestConfiguration.WorkflowType) (WorkflowExecution(RunId="Offline RunId", WorkflowId = workflowId))
                          ...
                          |> OfflineHistoryEvent (        // EventId = 11
                              ActivityTaskStartedEventAttributes(Identity=TestConfiguration.Identity, ScheduledEventId=5L))
                          |> OfflineHistoryEvent (        // EventId = 12
                              ActivityTaskCompletedEventAttributes(Result="Test Activity Result", ScheduledEventId=5L, StartedEventId=11L))
                          |> OfflineHistoryEvent (        // EventId = 13
                              DecisionTaskScheduledEventAttributes(StartToCloseTimeout="1200", TaskList=TestConfiguration.TaskList))
                          |> OfflineHistoryEvent (        // EventId = 14
