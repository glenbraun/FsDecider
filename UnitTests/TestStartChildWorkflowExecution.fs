...
module TestStartChildWorkflowExecution =
    ...
    let ``Start Child Workflow Execution with result of Initiated``() =
        ...
        let deciderFunc(dt:DecisionTask) =
            ...
            | StartChildWorkflowExecutionResult.Initiated(attr) when
                    ...
                    attr.LambdaRole = TestConfiguration.LambdaRole &&
    ...
    let ``Start Child Workflow Execution with result of Canceled``() =
        ...
        let offlineFunc = OfflineDecisionTask (TestConfiguration.WorkflowType) (WorkflowExecution(RunId="Offline RunId", WorkflowId = workflowId))
                          ...
                          |> OfflineHistoryEvent (        // EventId = 7
                              DecisionTaskScheduledEventAttributes(StartToCloseTimeout="1200", TaskList=TestConfiguration.TaskList))
                          |> OfflineHistoryEvent (        // EventId = 8
                              ChildWorkflowExecutionCanceledEventAttributes(Details="Child Canceled Details", InitiatedEventId=5L, StartedEventId=6L, WorkflowExecution=WorkflowExecution(RunId="23PiE4ElHg+kWb1hlLZ+igEWy2HkX5GQ1XqpiB52nF9qY=", WorkflowId="Child of Start Child Workflow Execution with result of Canceled"), WorkflowType=TestConfiguration.WorkflowType))
                          |> OfflineHistoryEvent (        // EventId = 9
                              DecisionTaskStartedEventAttributes(Identity=TestConfiguration.Identity, ScheduledEventId=7L))
                          |> OfflineHistoryEvent (        // EventId = 10
                              DecisionTaskCompletedEventAttributes(ScheduledEventId=7L, StartedEventId=9L))
    ...
    let ``Start Child Workflow Execution with result of Failed``() =
        ...
        let offlineFunc = OfflineDecisionTask (TestConfiguration.WorkflowType) (WorkflowExecution(RunId="Offline RunId", WorkflowId = workflowId))
                          ...
                          |> OfflineHistoryEvent (        // EventId = 7
                              DecisionTaskScheduledEventAttributes(StartToCloseTimeout="1200", TaskList=TestConfiguration.TaskList))
                          |> OfflineHistoryEvent (        // EventId = 8
                              ChildWorkflowExecutionFailedEventAttributes(Details="Child Failed Details", InitiatedEventId=5L, Reason="Child Failed Reason", StartedEventId=6L, WorkflowExecution=WorkflowExecution(RunId="23bUYzuurK69h/f7AunOcWRYH+8QBwYYQDAgVMAPOYOUY=", WorkflowId="Child of Start Child Workflow Execution with result of Failed"), WorkflowType=TestConfiguration.WorkflowType))
                          |> OfflineHistoryEvent (        // EventId = 9
                              DecisionTaskStartedEventAttributes(Identity=TestConfiguration.Identity, ScheduledEventId=7L))
                          |> OfflineHistoryEvent (        // EventId = 10
                              DecisionTaskCompletedEventAttributes(ScheduledEventId=7L, StartedEventId=9L))
    ...
    let ``Start Child Workflow Execution with result of TimedOut``() =
        ...
        let offlineFunc = OfflineDecisionTask (TestConfiguration.WorkflowType) (WorkflowExecution(RunId="Offline RunId", WorkflowId = workflowId))
                          ...
                          |> OfflineHistoryEvent (        // EventId = 4
                              DecisionTaskCompletedEventAttributes(ScheduledEventId=2L, StartedEventId=3L))
                          |> OfflineHistoryEvent (        // EventId = 5
                              StartChildWorkflowExecutionInitiatedEventAttributes(ChildPolicy=ChildPolicy.TERMINATE, Control="1", DecisionTaskCompletedEventId=4L, ExecutionStartToCloseTimeout="5", Input=childInput, LambdaRole=TestConfiguration.LambdaRole, TaskList=childTaskList, TaskStartToCloseTimeout="1200", WorkflowId=childWorkflowId, WorkflowType=TestConfiguration.WorkflowType))
                          |> OfflineHistoryEvent (        // EventId = 6
                              ChildWorkflowExecutionStartedEventAttributes(InitiatedEventId=5L, WorkflowExecution=WorkflowExecution(RunId="Child RunId", WorkflowId=childWorkflowId), WorkflowType=TestConfiguration.WorkflowType))
                          |> OfflineHistoryEvent (        // EventId = 7
                              DecisionTaskScheduledEventAttributes(StartToCloseTimeout="1200", TaskList=TestConfiguration.TaskList))
        ...
        let childOfflineFunc = OfflineDecisionTask (TestConfiguration.WorkflowType) (WorkflowExecution(RunId="Offline RunId", WorkflowId = workflowId))
                                  |> OfflineHistoryEvent (        // EventId = 1
                                      WorkflowExecutionStartedEventAttributes(ChildPolicy=ChildPolicy.TERMINATE, ExecutionStartToCloseTimeout="5", Input=childInput, LambdaRole=TestConfiguration.LambdaRole, ParentInitiatedEventId=5L, ParentWorkflowExecution=WorkflowExecution(RunId="Offline RunId", WorkflowId=workflowId), TaskList=TestConfiguration.TaskList, TaskStartToCloseTimeout="1200", WorkflowType=TestConfiguration.WorkflowType))
                                  |> OfflineHistoryEvent (        // EventId = 2
                                      DecisionTaskScheduledEventAttributes(StartToCloseTimeout="1200", TaskList=TestConfiguration.TaskList))
                                  |> OfflineHistoryEvent (        // EventId = 3
    ...
    let ``Start Child Workflow Execution with result of Terminated``() =
        ...
        let offlineFunc = OfflineDecisionTask (TestConfiguration.WorkflowType) (WorkflowExecution(RunId="Offline RunId", WorkflowId = workflowId))
                          ...
                          |> OfflineHistoryEvent (        // EventId = 9
                              DecisionTaskCompletedEventAttributes(ScheduledEventId=7L, StartedEventId=8L))
                          |> OfflineHistoryEvent (        // EventId = 10
                              ChildWorkflowExecutionTerminatedEventAttributes(InitiatedEventId=5L, StartedEventId=6L, WorkflowExecution=WorkflowExecution(RunId="23ZZVyn4AlgImS4xu++GeLBqDOcOaJaV0tawBGTEmkkOQ=", WorkflowId="Child of Start Child Workflow Execution with result of Terminated"), WorkflowType=TestConfiguration.WorkflowType))
                          |> OfflineHistoryEvent (        // EventId = 11
                              DecisionTaskScheduledEventAttributes(StartToCloseTimeout="1200", TaskList=TestConfiguration.TaskList))
    ...
    let ``Start Child Workflow Execution using do!``() =
        let workflowId = "Start Child Workflow Execution using do!"
        let childWorkflowId = "Child of " + workflowId
        let childInput = "Test Child Input"
        let childTaskList = TaskList(Name="Child")
