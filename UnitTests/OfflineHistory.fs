...
module OfflineHistory =
    ...
    let GenerateOfflineDecisionTaskCodeSnippet (tw:System.IO.TextWriter) (events:ResizeArray<HistoryEvent>) (substitutions:Map<string, string> option) =
        ...
        let GenAttributePropertyValueAssignment (tw:TextWriter) (event:HistoryEvent, name:string, value:System.Object) =
            ...
            | :? ActivityTaskTimeoutType as timeout ->                          fprintf tw "%s=TimeoutType.%O" name timeout
            | :? WorkflowExecutionTimeoutType as timeout ->                     fprintf tw "%s=TimeoutType.%O" name timeout
            | :? DecisionTaskTimeoutType as timeout ->                          fprintf tw "%s=TimeoutType.%O" name timeout
            | :? LambdaFunctionTimeoutType as timeout ->                        fprintf tw "%s=TimeoutType.%O" name timeout
            | :? WorkflowExecutionTimeoutType as timeout ->                     fprintf tw "%s=TimeoutType.%O" name timeout
            | :? CancelTimerFailedCause as cause ->                             fprintf tw "%s=Cause.%O" name cause
            | :? CancelWorkflowExecutionFailedCause as cause ->                 fprintf tw "%s=Cause.%O" name cause
            | :? CompleteWorkflowExecutionFailedCause as cause ->               fprintf tw "%s=Cause.%O" name cause
            | :? ContinueAsNewWorkflowExecutionFailedCause as cause ->          fprintf tw "%s=Cause.%O" name cause
            | :? FailWorkflowExecutionFailedCause as cause ->                   fprintf tw "%s=Cause.%O" name cause
            | :? RecordMarkerFailedCause as cause ->                            fprintf tw "%s=Cause.%O" name cause
            | :? RequestCancelActivityTaskFailedCause as cause ->               fprintf tw "%s=Cause.%O" name cause
            | :? RequestCancelExternalWorkflowExecutionFailedCause as cause ->  fprintf tw "%s=Cause.%O" name cause
            | :? ScheduleActivityTaskFailedCause as cause ->                    fprintf tw "%s=Cause.%O" name cause
            | :? ScheduleLambdaFunctionFailedCause as cause ->                  fprintf tw "%s=Cause.%O" name cause
            | :? StartLambdaFunctionFailedCause as cause ->                     fprintf tw "%s=Cause.%O" name cause
            | :? SignalExternalWorkflowExecutionFailedCause as cause ->         fprintf tw "%s=Cause.%O" name cause
            | :? StartChildWorkflowExecutionFailedCause as cause ->             fprintf tw "%s=Cause.%O" name cause
            | :? StartTimerFailedCause as cause ->                              fprintf tw "%s=Cause.%O" name cause
            | :? WorkflowExecutionCancelRequestedCause as cause ->              fprintf tw "%s=Cause.%O" name cause
            | :? WorkflowExecutionTerminatedCause as cause ->                   fprintf tw "%s=Cause.%O" name cause
