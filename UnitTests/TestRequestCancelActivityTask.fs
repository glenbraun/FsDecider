...
module TestRequestCancelActivityTask =
    ...
    let ``Request Cancel Activity Task with result of Finished``() =
        let workflowId = "Request Cancel Activity Task with result of Finished"
        ...
        let deciderFunc(dt:DecisionTask) =
            ...
            match cancel with
            | RequestCancelActivityTaskResult.Finished -> return "TEST PASS"
            | _ -> return "TEST FAIL"
        }
